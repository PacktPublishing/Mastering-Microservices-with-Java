...
public class UserControllerIntegrationTests {
    ...
    public void testGetById() {
        ...
        Map<String, Object> response
                = restTemplate.getForObject("http://localhost:2224/v1/user/1", Map.class);
    ...
    public void testGetById_NoContent() {
        ...
        ResponseEntity<Map> responseE = restTemplate.exchange("http://localhost:2224/v1/user/99", HttpMethod.GET, entity, Map.class);
    ...
    public void testGetByName() {
        ...
        ResponseEntity<Map[]> responseE = restTemplate.exchange("http://localhost:2224/v1/user/?name=User", HttpMethod.GET, entity, Map[].class, uriVariables);
        ...
        // Assumed only single instance exist for user name contains word "Big"
    ...
    public void testAdd() throws JsonProcessingException {
        ...
        ResponseEntity<Map> responseE = restTemplate.exchange("http://localhost:2224/v1/user", HttpMethod.POST, entity, Map.class, Collections.EMPTY_MAP);
        ...
        Map<String, Object> response
                = restTemplate.getForObject("http://localhost:2224/v1/user/3", Map.class);
